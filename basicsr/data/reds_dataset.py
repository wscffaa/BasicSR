...
@DATASET_REGISTRY.register()
class BringOldFilmREDSDataset(data.Dataset):
    """REDS dataset for training BringOldFilm.
    ...
    def __getitem__(self, index):
        ...
        # TODO: 这里对lq图像模拟老电影退化
        img_gts, img_lqs = film_degradation(img_gts, texture_dir=self.opt['texture_dir'])
